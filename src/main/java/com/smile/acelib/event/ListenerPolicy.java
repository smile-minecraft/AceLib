 ...
 * 事件監聽器的執行策略列舉。
 *
 * <p>對應 Plan §十二 Phase 7「Folia async context 安全邊界」：後續插件實作
 * {@link SafeEventListener} 時，可依 listener 是否需要 region-bound 物件
 * mutate 來標記；{@link SafeEventRegistry} 在 dispatch 階段會依
 * {@link ListenerPolicy} 與當前 {@link com.smile.acelib.platform.Platform 平台}
